/*
  ...
  - You are about to drop the column `obs` on the `Movimentos` table. All the data in the column will be lost.
...
INSERT INTO "new_Movimentos" ("createdAt", "entrada", "id", "updatedAt", "valor") SELECT "createdAt", "entrada", "id", "updatedAt", "valor" FROM "Movimentos";
